...
render_bracket_tree <- function(draw, results = NULL) {
  ...
  div(
    ...
    div(
      class = "mb-bracket-heading",
      span(class = "mb-bracket-heading-title", "Tournament Bracket"),
      span(
        class = "mb-bracket-heading-live",
...
ui <- fluidPage(
  ...
  stage.className = 'mb-export-stage';
  ...
  clone.style.width = '1540px';
  clone.style.minWidth = '1540px';
  clone.style.maxWidth = '1540px';
  ...
  clone.style.padding = '28px 32px 34px';

  const bracket = clone.querySelector('.modern-bracket');
  if(bracket){
    bracket.style.width = '1470px';
    bracket.style.minWidth = '1470px';
    bracket.style.maxWidth = '1470px';
    bracket.style.height = 'auto';
    bracket.style.minHeight = '760px';
    bracket.style.overflow = 'visible';
    bracket.style.background = '#ffffff';
    bracket.style.color = '#111827';
    bracket.style.margin = '0 auto';
  }
