...
render_bracket_tree <- function(draw, results = NULL) {
  ...
  div(
    ...
    div(
      style = "margin-bottom:12px;font-size:12px;color:#667085;",
      "Live bracket: confirmed results automatically advance winners."
    ),
    div(
    ...
    div(
      class = "bracket-legend",
      span(
        span(class = "legend-blue-box"),
        "Qualified (Winner)"
      ),
      span(
        span(class = "legend-red-line"),
        "Eliminated"
      ),
      span(
        span(class = "legend-blue-arrow", "→"),
...
/* ============================================================
   TOURNAMENT BRACKET — LIGHT PROFESSIONAL STYLE
   ============================================================ */
...
.modern-bracket{
  ...
  grid-template-columns:
    185px 205px 185px 190px 185px 205px 185px !important;
...
.mb-match{
  ...
  box-shadow:0 3px 8px rgba(16,24,40,.08) !important;
...
.mb-cup{
  ...
  filter:drop-shadow(0 4px 5px rgba(0,0,0,.12)) !important;
}
...
.mb-right-match::after{
  left:-34px !important;
  transform:translate(0,-5px) rotate(225deg) !important;
}

/* Hide connectors for fake alignment spacers */
