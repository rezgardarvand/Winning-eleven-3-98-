...
/* ============================================================
   SAFE REFERENCE-STYLE BRACKET — CSS ONLY
   No JavaScript / no external CDN / no server changes
   ============================================================ */
...
/* Existing live renderer marks eliminated names with line-through inline style. */
...
/* Existing live renderer marks winners in green. Turn that to blue. */
.mb-player[style*="#067647"]{
  color:#1570ef !important;
  font-weight:900 !important;
}

/* Later-round real entrants get blue emphasis and an arrow. */
...
/* Make existing bracket connector strokes blue. */
.mb-left-match::after,
...
/* Print-friendly high quality output using the browser's built-in PDF print. */
@media print {
  body *{
