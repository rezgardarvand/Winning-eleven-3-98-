...
ui <- fluidPage(
  ...
  if(!source){ alert('Tournament bracket is not visible.'); return; }
  ...
  if(bracket){
    bracket.style.width = '1450px';
    bracket.style.minWidth = '1450px';
    bracket.style.maxWidth = 'none';
  ...
  try{
    ...
    a.download = (filename || 'tournament_bracket_HD.png');
