...
/* ============================================================
   SAFE REFERENCE-STYLE OVERRIDE
   Appearance only — no Shiny logic changed
   ============================================================ */
...
.mb-match{
  ...
  box-shadow:0 3px 10px rgba(16,24,40,.08) !important;
  color:#101828 !important;
}
...
/* Winner shown in the NEXT round */
.mb-player-advanced{
...
/* Make current-match winner text blue as well */
...
/* Blue bracket connector strokes */
.mb-left-match::after,
...
/* Live legend / instruction row */
.modern-bracket-wrap > div:first-child{
  color:#667085 !important;
}

/* High quality capture remains light even though the app itself is dark */
